...
class TestApp(unittest.TestCase):
    ...
    def test_get_timezone(self):
        status, headers, body = self.mock_request('GET', '/Asia/Irkutsk')
        self.assertEqual(status, '200 OK')
        self.assertIn('Current time in Asia/Irkutsk:', body)

    # Тест для проверки конвертации времени из одной временной зоны в другую
    def test_convert_timezone(self):
        body = json.dumps({
            "date": {"date": "12.20.2021 22:21:05", "tz": "EST"},
            "target_tz": "Asia/Irkutsk"
        })
    ...
    def test_date_diff(self):
        body = json.dumps({
            ...
            "second_date": "12:30pm 2024-02-01", "second_tz": "Asia/Irkutsk"
        })
